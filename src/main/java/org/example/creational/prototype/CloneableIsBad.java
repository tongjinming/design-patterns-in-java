...
class Address implements Cloneable {
    ...
    // base class clone() is protected.clone方法原本是protected的，这里重写方法不然外部无法调用Address的Clone方法，重写后protected也可以改成public
    // deep copy
    @Override
...
class Person implements Cloneable {
    ...
    protected Object clone() throws CloneNotSupportedException {
        // 不能直接用super.clone()，因为Java中的默认clone方法实现了浅拷贝（shallow copy）
//        return super.clone();
        return new Person(
